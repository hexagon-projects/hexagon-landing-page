<template>
    <div class="pb-24 space-y-12 bg-gradient-to-b from-white to-gray-50 dark:from-black dark:to-black">
        <!-- Section Header -->
        <div class="flex flex-col items-center justify-center pt-16">
            <div class="flex items-center gap-2.5 mb-4">
                <div class="w-8 h-0.5 bg-blue-500"></div>
                <h4 class="text-gray-600 text-md dark:text-gray-400 font-medium tracking-wider">OUR TEAM</h4>
                <div class="w-8 h-0.5 bg-blue-500"></div>
            </div>
            <h1 class="mt-2 text-4xl md:text-5xl font-bold text-center text-gray-800 dark:text-white font-raleway leading-tight">
                Meet the Minds Behind <br/>
                <span class="bg-gradient-to-r from-blue-500 to-blue-700 bg-clip-text text-transparent">the Innovation</span>
            </h1>
        </div>

        <div class="grid grid-cols-1 gap-8 px-4 sm:grid-cols-2 lg:grid-cols-4 lg:px-16 max-w-7xl mx-auto">
            <div v-for="(member, index) in teamMembers" :key="index"
                class="group relative overflow-hidden rounded-2xl hover:scale-110 shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
                <div class="aspect-w-3 aspect-h-4">
                    ...
                    <!-- <div class="absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                        <div class="absolute bottom-0 left-0 right-0 p-6 text-white transform translate-y-6 group-hover:translate-y-0 transition-transform duration-300">
                            <h3 class="text-xl font-bold mb-1">Team Member</h3>
