    ...
    <Transition name="content-fade" mode="out-in">
      ...
      >
        ...
        <div class="flex justify-center">
          <img v-if="items[selected].image" :src="items[selected].image" alt="Content Image" class="rounded-lg max-h-[150px] w-auto object-contain" />
        </div>
      </div>
      ...
      <div 
        v-else 
        key="multi-content"
        class="z-10 p-6 space-y-4 transition-all duration-300"
      >
