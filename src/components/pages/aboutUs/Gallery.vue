<template>
    <div class="relative w-full pb-24 overflow-hidden rounded-xl">
        <div ref="scrollContainer" @mouseover="pauseScroll" @mouseleave="resumeScroll"
            ...
            <div v-for="(image, index) in images" :key="index"
                class="flex-shrink-0 w-1/3 h-[500px] rounded-xl overflow-hidden scroll-snap-align hover:scale-105 transition-all duration-300">
