...
const filteredPosts = computed(() => {
  ...
  if (searchQuery.value) {
    result = result.filter((item) => item.title.toLowerCase().includes(searchQuery.value.toLowerCase()) || item.description.toLowerCase().includes(searchQuery.value.toLowerCase()));
  }
