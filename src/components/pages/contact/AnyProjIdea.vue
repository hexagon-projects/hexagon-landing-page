...
<template>
    <div
        class="flex flex-col md:flex-row items-start justify-between gap-10 px-[16px] md:px-[112px] py-0 md:py-16 bg-gradient">
        <!-- Left Section -->
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <a href="mailto:contact@hexagon.com"
                        class="font-medium text-blue-600 dark:text-blue-400">contact@hexagon.com</a>
                </div>
            </div>
        ...
        <div class="w-full p-8 bg-white shadow-lg md:w-1/2 dark:bg-gray-800 rounded-xl">
            <h3 class="mb-6 text-xl font-semibold text-gray-900 dark:text-white">Request A Quote – let's work together.
            </h3>
