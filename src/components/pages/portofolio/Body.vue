...
<template>
    <div class="flex flex-col items-center md:px-[112px] dark:bg-black" id="portofolio">
        <div class="grid grid-cols-1 gap-14 md:grid-cols-2 lg:grid-cols-3">
            <div v-for="(card, index) in cardItems" :key="card.id" class="bg-white dark:bg-black dark:hover:shadow-gray-800 transition-all duration-300 hover:shadow-2xl hover:shadow-gray-200  overflow-hidden p-[24px] max-w-[395px] rounded-2xl flex-shrink-0">
                ...
                <div class="space-y-[16px]">
                    ...
                    <a :href="card.urlYoutube" target="_blank" class="inline-block">
