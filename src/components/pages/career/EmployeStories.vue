    ...
    <div class="px-[56px] md:px-[112px]">
        ...
        <div class="relative">
            <div class="flex items-center justify-between">
                <button @click="prevSlide" class="absolute left-0 z-10 p-2 transition-all duration-300 bg-white rounded-full shadow-md dark:bg-black hover:bg-gray-100 dark:hover:bg-gray-800">
                ...
                <div class="mx-24 overflow-hidden">
                    <div class="flex transition-transform duration-500 ease-in-out" :style="{ transform: `translateX(-${currentSlide * 100}%)` }">
                        <div v-for="(story, index) in employeeStories" :key="index" class="flex-shrink-0 w-full">
                            <div class="p-8 transition-all duration-300 bg-white border border-gray-100 dark:bg-black rounded-2xl dark:border-gray-800">
                                <div class="flex flex-col items-center gap-6">
                                    <div class="relative">
                                        <img :src="story.image" :alt="story.name" class="object-cover rounded-full w-28 h-28 ring-4 ring-blue-100 dark:ring-blue-900"/>
                                        <div class="absolute p-2 text-white bg-blue-600 rounded-full -bottom-2 -right-2">
                                    ...
                                    <div class="relative">
                                        <svg class="absolute w-6 h-6 text-blue-600 -top-3 -left-2 dark:text-gray-600" fill="currentColor" viewBox="0 0 24 24">
                                            <path d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10h-9.983zm-14.017 0v-7.391c0-5.704 3.748-9.57 9-10.609l.996 2.151c-2.433.917-3.996 3.638-3.996 5.849h3.983v10h-9.983z"/>
                                        </svg>
                                        <p class="px-6 text-lg italic leading-relaxed text-center text-gray-600 dark:text-gray-300">{{ story.testimony }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <button @click="nextSlide" class="absolute right-0 z-10 p-2 transition-all duration-300 bg-white rounded-full shadow-md dark:bg-black hover:bg-gray-100 dark:hover:bg-gray-800">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
