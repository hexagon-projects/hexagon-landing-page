...
<template>
  <div class="px-4 md:px-[112px]">
    <div class="flex flex-col gap-9 items-center text-center mb-[60px]">
      ...
      <h1 class="font-raleway text-[30px] font-bold text-gray-800 dark:text-gradient">
    ...
    <div class="relative">
      <div class="flex items-center justify-between">
        <button @click="prevSlide" class="absolute hidden md:block left-0 z-10 p-6 transition-all duration-300 bg-gray-50 rounded-full dark:bg-gray-800/50 hover:bg-gray-100 dark:hover:bg-gray-800">
            ...
            <div v-for="(story, index) in employeeStories" :key="index" class="flex-shrink-0 w-full">
              <div class="p-6 md:p-8 transition-all duration-300 bg-white dark:bg-black rounded-2xl dark:border-gray-800">
                ...
                <div class="flex flex-col items-center gap-6 md:flex-row">
                  <!-- Gambar profil -->
                  <img :src="story.image" :alt="story.name" class="object-cover rounded-full aspect-square w-32 h-32 md:w-48 md:h-48 ring-4 ring-blue-100 dark:ring-blue-900" />
                  
                  <!-- Konten teks -->
                  <div class="text-left">
                    <div class="space-y-2 px-4 md:px-6 relative">
                      <!-- Icon double quotes -->
                      <img src="@/assets/career/double-quotes.svg" alt="" class="absolute right-0 top-0 w-8 h-8 md:w-10 md:h-10" />
        ...
        <button @click="nextSlide" class="absolute hidden md:block right-0 z-10 p-6 transition-all duration-300 bg-gray-50 rounded-full dark:bg-gray-800/50 hover:bg-gray-100 dark:hover:bg-gray-800">
          <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
